...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-20 sm:py-24 bg-white relative overflow-hidden">
      ...
      <div
        ref={heroRef}
        className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center relative z-10"
      >
        <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
          <div>
            <h2 className="text-lg sm:text-xl font-normal text-gray-700 mb-2">
              Hi! am
            </h2>
          ...
          <p className="text-gray-700 text-base sm:text-lg max-w-md mx-auto lg:mx-0 px-2 sm:px-0">
            Hey! I'm Sarin M S. I'm interested into Front End web development
            and Poster, UI/UX designing.
          </p>

          <div className="flex justify-center lg:justify-start px-2 sm:px-0">
            <a
              href="/assets/Sarin_MS_Resume.pdf"
              download="Sarin_MS_Resume.pdf"
              className="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 text-white font-semibold rounded-lg shadow-md hover:bg-orange-600 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
        ...
        <div className="flex justify-center lg:justify-end mt-8 lg:mt-0 lg:mr-20">
          <div className="relative w-56 h-56 xs:w-64 xs:h-64 sm:w-72 sm:h-72 md:w-80 md:h-80">
            <div
              className="absolute inset-0 rounded-full bg-linear-to-b from-transparent via-orange-300/50 to-orange-500"
              style={{ padding: "4px" }}
            >
